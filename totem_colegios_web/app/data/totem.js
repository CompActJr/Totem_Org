...
export const unidades = [
  {
    ...
    image: new URL("../assets/imagens/FACHADA-CACHOEIRA.jpg", import.meta.url)
      .href,
    heroImage: new URL(
      "../assets/imagens/BANNER-1-CACHOEIRA.jpg",
      import.meta.url,
    ).href,
    levels: [
      "Berçário",
  ...
  },
  {
    city: "Cruz Alta",
    slug: "cruz-alta",
    image: new URL("../assets/imagens/FACHADA-CRUZ-ALTA.jpg", import.meta.url)
      .href,
    // TODO: trocar pelas imagens reais da unidade Cruz Alta
    heroImage: new URL(
      "../assets/imagens/FACHADA-CRUZ-ALTA.jpg",
      import.meta.url,
    ).href,
  ...
  },
  {
    city: "Santa Maria",
    slug: "santa-maria",
    image: new URL("../assets/imagens/FACHADA-SANTA-MARIA.jpg", import.meta.url)
      .href,
    // TODO: trocar pelas imagens reais da unidade Santa Maria
    heroImage: new URL(
      "../assets/imagens/FACHADA-SANTA-MARIA.jpg",
      import.meta.url,
    ).href,
    levels: ["Ensino Fundamental I e II", "Ensino Médio"],
    link: "santa-maria",
...
export const educationLevelsInfo = [
  {
    name: "Berçário",
    image: new URL("../assets/imagens/NIVEL-BERÇARIO.jpg", import.meta.url)
      .href,
    link: "bercario",
  },
  {
    name: "Educação Infantil",
    image: new URL("../assets/imagens/NIVEL-INFANTIL.jpg", import.meta.url)
      .href,
    link: "infantil",
  },
  {
    name: "Ensino Fundamental I",
    image: new URL("../assets/imagens/NIVEL-FUNDAMENTAL-1.jpg", import.meta.url)
      .href,
    link: "fundamental1",
  },
  {
    name: "Ensino Fundamental II",
    image: new URL("../assets/imagens/NIVEL-FUNDAMENTAL-2.jpg", import.meta.url)
      .href,
    link: "fundamental2",
  },
  {
...
export const activities = [
  {
    ...
    icon: new URL(
      "../assets/imagens/ESCOLINHA-DE-VOLEIBOL.jpg",
      import.meta.url,
    ).href,
    link: "#",
  },
...
export const results = [
  {
    ...
    image: new URL("../assets/imagens/RESULTADO-1-CS.jpg", import.meta.url)
      .href,
  },
];
